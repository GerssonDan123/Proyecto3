 ...
 * @author gersson
 */
public class Sector_Coordinador extends UnicastRemoteObject implements InterfaceRemota, Serializable 
{
    ...
    //Constructor
   public Sector_Coordinador() throws RemoteException
   {
       super();
   }
    ...
    public int iniClient() throws RemoteException, IOException, WriteAbortedException, NotSerializableException, ServerNotActiveException
        ...
        Sector_MonClient ObjMon = new Sector_MonClient();
    ...
    public static void main(String args[]) throws RemoteException 
    {
        ...
        {           //variable
            ...
            VarRegistro.rebind("Coordinador", new Sector_Coordinador());
